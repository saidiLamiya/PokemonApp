 ...
 */
public class ListOfPokemon<retrofit> extends Fragment {
    ...
    static ListOfPokemon instance;
    public static ListOfPokemon getInstance(){
        if(instance == null)
            instance = new ListOfPokemon();
        return instance;}
    ...
    public static ListOfPokemon newInstance(float param1, float param2) {
        ListOfPokemon fragment = new ListOfPokemon();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View viewItem = inflater.inflate(R.layout.fragment_list_of_pokemon, container, false);
       Pokemon pokemon;
//
...
//
    ...
    //Récuperer les données de l'API et inserer les données(taille,poids,abilitées,ordre et base d'éxperience)
    private void setDetailPokemon(int j) {
        PokeApiService service = retrofit.create(PokeApiService.class);
        int a=Common.commonPokemonList.get(j-1).getNumber();
        Log.i(TAG, "setDetailPokemon: " +a);
        Call<PokemonById> pokemonResponseCall = service.OnePokemon(a);
